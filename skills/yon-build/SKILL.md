...
Authentication, authorization, billing, destructive operations, migrations, security controls, external integrations, tenancy/isolation, and core business rules require stronger understanding and verification. Execution may be blocked when required evidence or authorization is unavailable.
